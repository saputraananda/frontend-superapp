      ...
      <div className="relative z-[9999] pointer-events-auto w-full max-w-3xl max-h-[90vh] bg-white rounded-2xl shadow-2xl ring-1 ring-black/10 flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between gap-3 px-5 py-3.5 border-b border-slate-100 bg-white shrink-0">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            >
              <HiOutlineDocumentText className={cn("w-4 h-4", isPdf ? "text-red-600" : "text-slate-600")} />
            </div>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <a
              href={url}
              download={fileName}
              className="flex items-center gap-1.5 rounded-lg px-3 py-1.5 bg-[#97bd3f]/10 border border-[#97bd3f]/25 text-xs font-medium text-[#1b3459] hover:bg-[#97bd3f]/20 transition"
            >
        ...
        <div className="flex-1 overflow-auto bg-slate-50 flex items-center justify-center min-h-0">
          {isPdf ? (
            <iframe src={url} title={label} className="w-full h-full min-h-[60vh]" style={{ border: "none" }} />
          ) : (
            <div className="p-4 flex items-center justify-center w-full">
              ...
              <div className="hidden flex-col items-center gap-3 text-slate-400 py-12">
                ...
                <a href={url} target="_blank" rel="noopener noreferrer" className="text-xs text-slate-600 underline">
                  Buka di tab baru
                </a>
              </div>
            </div>
...
function PhotoCard({ label, filePath, fileName, baseUrl, avatarBaseUrl, onPreview }) {
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-4 flex flex-col gap-3">
      ...
      {fileName && (
        <p className="text-[11px] text-slate-400 -mt-1 truncate" title={fileName}>
          {fileName}
        </p>
      )}
        ...
        isPdf ? (
          ...
          >
            ...
            <span className="text-[10px] text-red-300 group-hover:text-red-500 transition flex items-center gap-1">
              <HiOutlineMagnifyingGlassPlus className="w-3 h-3" />
              Klik untuk preview
            </span>
          </button>
        ) : !imgError ? (
          ...
          >
            <img src={url} alt={label} className="w-full max-h-60 object-contain" onError={() => setImgError(true)} />
      ...
      {url && (
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 rounded-lg border border-[#97bd3f]/25 bg-[#97bd3f]/10 px-3 py-2 text-xs font-medium text-[#1b3459] hover:bg-[#97bd3f]/20 transition"
          >
            <HiOutlineArrowDownTray className="w-3.5 h-3.5" />
            Download
          </button>
...
const inputCls = (err) =>
  cn(
    ...
    "focus:ring-2 focus:ring-[#1b3459]/20 focus:border-[#1b3459]",
...
export default function EmployeeCleanoxDetail() {
  const { id } = useParams();
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        document.title = `${emp.full_name ?? "Karyawan"} | Karyawan Cleanox`;
      } catch (e) {
        setError(e.message);
      } finally {
        setLoading(false);
  ...
  const resolveAvatarUrl = () => {
    const base = employee?.avatars_base_url;
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative z-50 w-full max-w-md mx-4 bg-white rounded-2xl shadow-2xl p-6">
            ...
            <div className="flex gap-2 mt-5">
              ...
              <button
                disabled={!resignDate || resignSaving}
        ...
        <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => navigate("/cleanox-management-system")}
              ...
              <div>
                <div className="flex items-center gap-1.5 text-xs text-slate-400 mb-0.5">
                  <button onClick={() => navigate("/portal")} className="hover:text-[#1b3459] transition">
                    Portal
                  </button>
                  <span>/</span>
                  <button onClick={() => navigate("/cleanox-management-system")} className="hover:text-[#1b3459] transition">
                    Karyawan Cleanox
                  </button>
                  <span>/</span>
                ...
                <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                  ...
                  {isResigned ? (
                    ...
                    <span className="inline-flex items-center rounded-full bg-[#97bd3f]/15 border border-[#97bd3f]/25 px-2 py-0.5 text-[10px] font-semibold text-[#1b3459]">
                ...
                <div className="mt-auto pt-4 border-t border-slate-100 space-y-2">
                  <button
                    ...
                    className={cn(
                      ...
                      dirty ? "bg-[#97bd3f] text-white hover:bg-[#86aa34] shadow-sm" : "bg-slate-100 text-slate-400 cursor-not-allowed",
                    )}
                  >
          ...
          <div className="flex gap-5">
            ...
            <aside className="hidden lg:flex flex-col w-56 xl:w-60 shrink-0 gap-3 self-start sticky top-6">
              ...
              <div className="rounded-xl border border-slate-200 bg-white shadow-sm p-4 flex flex-col items-center gap-3">
                ...
                <div
                  className={`h-20 w-20 rounded-full bg-slate-100 border-2 border-slate-200 items-center justify-center ${
                    resolveAvatarUrl() ? "hidden" : "flex"
                  }`}
                >
                ...
                {TABS.map(({ id: tid, label, Icon }) => (
                  <button
                    ...
                    className={cn(
                      ...
                      activeTab === tid ? "bg-[#1b3459] text-white shadow-md shadow-[#1b3459]/30" : "text-slate-600 hover:bg-slate-50 hover:text-slate-900",
                    )}
                  >
                    <span className="flex items-center gap-2.5">
                      <Icon className="w-4 h-4 shrink-0" />
              ...
              <div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                ...
                <div className="border-b border-slate-100 bg-slate-50 px-4 sm:px-6 py-4 flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3 min-w-0">
                    {activeTabObj && (
                      <div className="flex items-center justify-center h-9 w-9 rounded-lg bg-[#97bd3f]/10 border border-[#97bd3f]/25 text-[#1b3459] shrink-0">
                        ...
                        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
                          ...
                          <Field label="Email Perusahaan" error={fieldErrors.email}>
                            <input
                              ...
                              placeholder="email@cleanoxalora.com"
                              autoComplete="off"
                            />
                          </Field>
                          ...
                          <Field label="Username" hint="Digunakan untuk login karyawan." error={fieldErrors.username}>
                            <input
                              type="text"
                              name="username"
                          ...
                          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
                            ...
                            <Field label="Alasan Keluar">
                              <input
                                ...
                                onChange={handleChange}
                                className={inputCls(false)}
                                placeholder="Contoh: Mengundurkan diri, kontrak habis, PHK"
                              />
                            </Field>
                          </div>
                        </Panel>
                      ...
                      <div className="flex items-center justify-between gap-3 flex-wrap">
                        ...
                        {uploadedDocCount > 0 && (
                          <button
                            ...
                            disabled={zipping}
                            className="flex items-center gap-1.5 rounded-lg border border-[#97bd3f]/25 bg-[#97bd3f]/10 px-3 py-2 text-xs font-semibold text-[#1b3459] hover:bg-[#97bd3f]/20 disabled:opacity-60 transition shrink-0"
                          >
                            {zipping ? (
                              <>
                                <span className="h-3.5 w-3.5 animate-spin rounded-full border-2 border-[#97bd3f] border-t-transparent" />
                                Menyiapkan ZIP...
                              </>
                            ) : (
                              <>
                    ...
                    <div className="flex gap-2">
                      ...
                      {activeTabIdx < TABS.length - 1 && (
                        <button
                          type="button"
                          onClick={() => handleTabChange(TABS[activeTabIdx + 1].id)}
                          className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 hover:text-slate-900 transition"
                        >
                          Berikutnya
