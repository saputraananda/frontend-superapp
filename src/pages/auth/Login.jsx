                                    ...
                                    <div>
                                        ...
                                        <div className="relative mt-1">
                                            <input
                                                ...
                                                className="w-full rounded-2xl border border-white/50 bg-white/45 px-4 py-3 pr-11 text-sm text-slate-900 placeholder:text-slate-400 shadow-sm outline-none backdrop-blur-md transition focus:border-indigo-300 focus:ring-4 focus:ring-indigo-200/50"
                                                placeholder="••••••••"
                                            ...
                                            <button
                                                ...
                                                className="absolute inset-y-0 right-3 flex items-center px-1 text-slate-400 hover:text-slate-600 transition"
                                                tabIndex={-1}
