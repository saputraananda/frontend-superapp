          ...
          <tr>
            <td style="width: 48%; vertical-align: top;">
              ...
              <div style="height: 96px; background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
                ${getSignatureUrl(delivery.signature_hospital) ? `<img src="${getSignatureUrl(delivery.signature_hospital)}" alt="Hospital signature" style="height: 100%; object-fit: contain;" />` : '<span style="font-size: 10px; color: #94a3b8; font-style: italic;">Tidak ada tanda tangan</span>'}
              </div>
            ...
            <td style="width: 48%; vertical-align: top;">
              ...
              <div style="height: 96px; background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
                ${getSignatureUrl(delivery.signature_valet) ? `<img src="${getSignatureUrl(delivery.signature_valet)}" alt="Valet signature" style="height: 100%; object-fit: contain;" />` : '<span style="font-size: 10px; color: #94a3b8; font-style: italic;">Tidak ada tanda tangan</span>'}
              </div>
