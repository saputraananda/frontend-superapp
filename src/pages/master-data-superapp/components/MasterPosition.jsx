...
export default function MasterPosition() {
	...
	const fetchItems = useCallback(async () => { setLoading(true); try { const r = await api("/positions"); setItems(r.positions || []); } catch { showToast("error", "Gagal memuat data jabatan"); } finally { setLoading(false); } }, [showToast]);
