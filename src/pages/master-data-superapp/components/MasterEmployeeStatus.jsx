...
export default function MasterEmployeeStatus() {
	...
	const fetchItems = async () => { setLoading(true); try { const r = await api("/employment-statuses"); setItems(r.employeeStatuses || []); } catch { showToast("error", "Gagal memuat data status karyawan"); } finally { setLoading(false); } };
